 ...
 * Run: node update-image-refs.cjs
 */
const fs = require("fs");
...
const REPLACEMENTS = [
  ...
  // WhatsApp images: .jpeg → .webp (but NOT logo.jpeg, NOT favicon ref)
  ...
  // ChatGPT in URL-encoded form (for OG/meta tags)
  { find: /ChatGPT%20Image%20([^"']+?)\.png/g, replace: "ChatGPT%20Image%20$1.webp" },
];
